...
export const STYLE_LEVEL_TO_CLASSES = {
  ...
  h1: "font-semibold text-5xl uppercase tracking-wide",
  h2: "font-semibold text-4xl uppercase tracking-wide",
  h3: "font-semibold text-3xl uppercase tracking-wide",
  h4: "font-semibold text-2xl uppercase tracking-wide",
  h5: "text-base font-semibold uppercase tracking-wide",
  logo: "text-logo lowercase font-variable",
  "p-lg": "text-p-lg font-body",
  p: "text-p font-body",
  "p-sm": "text-p-sm font-body",
...
export const Text = <T extends AsElement>({
  ...
  const classes = c(getStyleLevelClasses(styleAs ?? renderAs), className);
  const Element = React.createElement(
    renderAs,
    { className: classes, role, ...rest },
    children,
  );
